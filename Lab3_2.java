...
// Исходная строка: 0048180   ,..,.,,0572700,,., 4720 02850  ..,  yjjme9603000
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Преобразованная строка: " + s);
        ...
        if (pr == maxx) {
            ...
            System.out.println("Слово с максимальным количеством нулей: " + ma);
        }
        scanner.close();
    }
}